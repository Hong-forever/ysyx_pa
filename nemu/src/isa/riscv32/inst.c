...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , M, R(rd) = (uint64_t)(src1 * src2));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , M, R(rd) = (int64_t)((int32_t)src1 * (int32_t)src2) >> 32);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , M, R(rd) = (int64_t)((int32_t)src1 * src2) >> 32);
